...
# Su    bclass for the restructuring the embedding model adding classification head after contrastive training
class RedesineModel(nn.Module):
    def __init__(self, model, embedding_model):
        super(RedesineModel, self).__init__()
        self.model = model
        self.classification_layer = self.model.fc
        self.embedding_model = embedding_model
        self.last_layer = self.classification_layer
...
if __name__ == "__main__":
    ...
    embeddingmodeltrained = contrastivelr.contrastive_train()
    print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
    finetunedmodel = RedesineModel(model, embeddingmodeltrained)
